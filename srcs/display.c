...
/*   Updated: 2015/03/02 15:05:56 by nschilli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_zoom(t_env *e)
{
	...
	{
		e->b.minX += e->mouse.x / 5 / e->zoom;
		e->b.maxX += e->mouse.x / 5 / e->zoom;
		e->b.minY += e->mouse.y / 5 / e->zoom;
		e->b.maxY += e->mouse.y / 5 / e->zoom;
		e->zoom *= 1.015;
	}
}
